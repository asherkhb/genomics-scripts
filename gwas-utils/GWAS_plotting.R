...
lambda_gc <- function(p) {
  qchisq(median(p), df=1, lower.tail=FALSE) / qchisq(0.5, df=1, lower.tail=FALSE)
}

# Source: http://genome.sph.umich.edu/wiki/Code_Sample:_Generating_QQ_Plots_in_R
...
# Source: http://genome.sph.umich.edu/wiki/Code_Sample:_Generating_Manhattan_Plots_in_R
